...
export default function ProfileCard({
  ...
  return (
    <View className="h-auto w-auto justify-center align-center flex-col mb-4 p-4  drop-shadow-md bg-neutral-100 shadow-lg shadow-black dark:shadow-white dark:bg-[#202020]">
      ...
      <View className="py-4 ml-2 bg-transparent flex-1 justify-center">
        ...
        <View className="px-1 bg-transparent flex-1">
          <Text
            className="text-lg text-neutral-700/90 dark:text-neutral-200/90"
            numberOfLines={1}
          >
            {firstName + ' ' + lastName}
          </Text>
